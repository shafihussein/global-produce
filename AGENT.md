...
- `agentic_rules/context.md`
- `agentic_rules/git_rules.md`
- `agentic_rules/server-architecture-rules.md`
- `agentic_rules/UI-component-rules.md`
- `agentic_rules/constraints.md` (empty at merge time)
- `agentic_rules/standards.md` (empty at merge time)
